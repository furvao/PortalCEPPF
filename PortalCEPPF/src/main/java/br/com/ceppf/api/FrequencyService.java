...
import br.com.ceppf.request.FrequencyIn;
...
public class FrequencyService {
	...
	public Response getFrequency(FrequencyIn frequencyIn) {
	...
	public Response saveFrequency(FrequencyIn frequencyIn) {
	...
	public Response updateFrequency(FrequencyIn frequencyIn) {
	...
	public Response login(FrequencyIn frequencyIn) {
